...
const Footer = () => {
  return (
    <footer className="pt-[4.7rem] pb-[6.8rem] px-[10rem] bg-gray-2  sm:pl-[1.5rem] sm:px-[1rem] sm:pb-[6.5rem] sm:pt-[2.5rem] md:px-[4rem] relative z-0">
      <div className="flex flex-row px-[3rem] md:px-[2.5rem] justify-between sm:flex-col-reverse gap-[11rem] mt-[4.5rem] sm:gap-[1rem] sm:items-start sm:m-0 sm:px-[0.5rem] ">
        <div className="flex flex-col gap-[1rem]">
          <p className="text-gray-3 md:text-1.125-500 sm:text-1-500 sm:items-left sm:my-[1rem]">
            Fitculator (핏큘레이터) <br />
