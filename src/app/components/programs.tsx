...
const Programs = () => {
  return (
    <div className="flex flex-col items-center justify-center py-[5.625rem] px-[31.875rem] gap-[6.875rem] text-gray-3 bg-beige-1 sm:px-[1rem] md:px-[1rem] md:py-[4rem] md:pb-[6rem]">
