...
export default function Intro() {
  return (
    <div className="py-[20rem] bg-gray-2 flex flex-col items-center justify-center">
      <div className="flex flex-col gap-[3rem] items-center">
        ...
        <div className="flex flex-col items-center justify-center gap-[1.38rem] text-gray-3 text-2-600">
