...
export default function Intro() {
  return (
    <section className="w-full max-w-4xl mx-auto py-20 lg:py-20 md:py-16 sm:py-12 xs:py-10 px-4">
      <div className="flex items-center justify-center gap-2 text-2-700 lg:text-2-700 md:text-1.75-700 sm:text-1.5-700 xs:text-1.25-700 text-center mb-16 lg:mb-16 md:mb-12 sm:mb-10 xs:mb-8 text-green">
        <Image
          src="/svg/logo.svg"
          alt="Orevo"
          width={100}
