...
const privacyPolicyItems: privacyPolicyItems = [
  {
    title: '제1조(목적)',
    content: (
      <>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="pl-6 list-decimal">
          <li>
            필수 수집 정보: 보호자 이름, 보호자 생년월일, 보호자 성별, 보호자
            내/외국인 여부, 보호자 휴대폰 번호, 보호자 이동통신사 정보, 보호자
            아이핀 정보(아이핀 확인 시), 보호자 본인확인값(CI,DI) 및 본인과의
            관계
          </li>
        </ul>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="pl-6 list-decimal">
          <li>
            필수 수집 정보: 현금영수증 발행 대상자 이름, 현금영수증 발행 대상자
            생년월일, 현금영수증 발행 대상자 주소, 휴대폰 번호 및 현금영수증
            카드번호
          </li>
        </ul>
      </>
  ...
  {
    title: '제11조(서비스 이용 및 부정 이용 확인을 위한 정보)',
    content: (
      <>
        <p>
          회사는 이용자의 서비스 이용에 따른 통계∙분석 및 부정이용의 확인∙분석을
          위하여 다음과 같은 정보를 수집합니다. (부정이용이란 회원탈퇴 후
          재가입, 상품구매 후 구매취소 등을 반복적으로 행하는 등 회사가 제공하는
  ...
  {
    title: '제27조(개인정보 유출 등에 대한 조치의 예외)',
    content: (
      <>
        <p>
      ...
      <>
        <ul className="pl-6 list-decimal">
          ...
          <li>
            ...
            따라 이용자에게 알린 경우에는 개인정보 처리위탁ㆍ보관에 따른
  ...
  {
    title: '제29조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)',
    content: (
      <>
        <ul className="pl-6 list-decimal">
          <li>
